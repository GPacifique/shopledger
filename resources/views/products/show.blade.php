<x-app-layout>
        ...
        <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div class="flex items-center gap-3 min-w-0">
                <a href="{{ route('products.index') }}"
                   class="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl border border-gray-200 bg-white text-gray-500 shadow-sm transition hover:bg-gray-50 hover:text-gray-900">
                ...
                <div class="min-w-0">
                    <div class="flex items-center gap-2">
                        ...
                        @if($product->status === 'active')
                            <span class="hidden sm:inline-flex items-center gap-1 rounded-full bg-emerald-50 px-2.5 py-1 text-xs font-semibold text-emerald-700 ring-1 ring-inset ring-emerald-600/20">
                                <span class="h-1.5 w-1.5 rounded-full bg-emerald-500"></span>
                                Active
                            </span>
                        @else
                            <span class="hidden sm:inline-flex items-center gap-1 rounded-full bg-gray-100 px-2.5 py-1 text-xs font-semibold text-gray-600">
                                Inactive
                            </span>
                        @endif
                    </div>
                    ...
                    <p class="mt-0.5 text-sm text-gray-500">
                        Product details, inventory and financial performance
                    </p>
                </div>
            </div>
            ...
            <div class="flex items-center gap-2">
                <a href="{{ route('products.index') }}"
                   class="hidden sm:inline-flex items-center gap-2 rounded-xl border border-gray-200 bg-white px-4 py-2.5 text-sm font-semibold text-gray-700 shadow-sm transition hover:bg-gray-50">
    ...
    @php
        ...
        $stockValue = $product->stock * $product->buying_price;
        $potentialSales = $product->stock * $product->selling_price;
        ...
        $stockPercentage = $product->minimum_stock > 0
            ? min(100, ($product->stock / $product->minimum_stock) * 100)
            : 100;
    ...
    <div class="min-h-screen bg-gray-50/70 py-6 sm:py-8">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 space-y-6">
            ...
            <section class="overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-sm">
                <div class="relative">
                    <div class="absolute inset-0 bg-gradient-to-r from-indigo-50 via-white to-emerald-50 opacity-70"></div>

                    <div class="relative p-5 sm:p-7">
                        <div class="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">

                            <div class="flex items-start gap-5">
                                <div class="flex h-16 w-16 shrink-0 items-center justify-center rounded-2xl bg-indigo-600 text-white shadow-lg shadow-indigo-600/20">
                                ...
                                <div class="min-w-0">
                                    <div class="flex flex-wrap items-center gap-2">
                                        ...
                                        <span class="inline-flex items-center gap-1.5 rounded-full px-2.5 py-1 text-xs font-semibold ring-1 ring-inset {{ $stockStatusClass }}">
                                    ...
                                    <div class="mt-2 flex flex-wrap items-center gap-x-4 gap-y-2 text-sm text-gray-500">
                                        <span class="inline-flex items-center gap-1.5">
                                            ...
                                            <span class="font-mono font-semibold text-gray-700">{{ $product->sku }}</span>
                                        </span>
                                        ...
                                        @if($product->barcode)
                                            ...
                                            <span class="inline-flex items-center gap-1.5">
                                                <span class="font-medium text-gray-400">Barcode</span>
                            ...
                            {{-- QR --}}
                            <div class="flex items-center gap-4 rounded-2xl border border-gray-200 bg-white/90 p-3 shadow-sm">
                                <div>
            ...
            <section class="grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-4">
                ...
                <div class="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm transition hover:shadow-md">
                    ...
                    <div class="mt-4 flex items-center justify-between border-t border-gray-100 pt-3">
                        <span class="text-xs text-gray-500">Units purchased</span>
                ...
                <div class="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm transition hover:shadow-md">
                    <div class="flex items-start justify-between">
                        <div>
                            <p class="text-sm font-medium text-gray-500">Sales Value</p>
                            <p class="mt-2 text-2xl font-bold tracking-tight text-gray-900">
                                {{ rwf($totalSales) }}
                            </p>
                        </div>
                        ...
                        <div class="flex h-11 w-11 items-center justify-center rounded-xl bg-indigo-50 text-indigo-600">
                            <svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8"
                                      d="M3 12l3-3 4 4 7-8 4 4M21 5v5h-5"/>
                            </svg>
                        </div>
                    </div>

                    <div class="mt-4 flex items-center justify-between border-t border-gray-100 pt-3">
                        <span class="text-xs text-gray-500">Units sold</span>
                        <span class="text-sm font-semibold text-gray-700">
                ...
                {{-- Gross Profit --}}
                <div class="rounded-2xl border border-emerald-200 bg-gradient-to-br from-emerald-50 to-white p-5 shadow-sm transition hover:shadow-md">
                    <div class="flex items-start justify-between">
                        <div>
                            <p class="text-sm font-medium text-emerald-700">Gross Profit</p>
                            <p class="mt-2 text-2xl font-bold tracking-tight {{ $grossProfit >= 0 ? 'text-emerald-700' : 'text-red-600' }}">
                                {{ rwf($grossProfit) }}
                            </p>
                        </div>
                        ...
                        <div class="flex h-11 w-11 items-center justify-center rounded-xl bg-emerald-100 text-emerald-600">
                            <svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8"
                                      d="M12 8c-2.21 0-4 1.12-4 2.5S9.79 13 12 13s4 1.12 4 2.5S14.21 18 12 18m0-10V6m0 12v-2m8-4a8 8 0 11-16 0 8 8 0 0116 0z"/>
                            </svg>
                        </div>
                    </div>

                    <div class="mt-4 flex items-center justify-between border-t border-emerald-100 pt-3">
                        <span class="text-xs text-emerald-700">Realized margin</span>
                        <span class="text-sm font-bold {{ $realizedMargin >= 0 ? 'text-emerald-700' : 'text-red-600' }}">
                ...
                <div class="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm transition hover:shadow-md">
                    <div class="flex items-start justify-between">
                        <div>
                            ...
                            <p class="mt-2 text-2xl font-bold tracking-tight {{ $stockValueClass }}">
                    ...
                    <div class="mt-4">
                        ...
                        <div class="h-2 overflow-hidden rounded-full bg-gray-100">
                            <div class="h-full rounded-full {{ $product->stock <= 0 ? 'bg-red-500' : ($product->stock <= $product->minimum_stock ? 'bg-amber-500' : 'bg-emerald-500') }}"
            ...
            <section class="grid grid-cols-1 gap-6 lg:grid-cols-3">
                ...
                <div class="lg:col-span-2 rounded-2xl border border-gray-200 bg-white shadow-sm">
                    <div class="flex items-center justify-between border-b border-gray-100 px-5 py-4 sm:px-6">
                        <div>
                            ...
                            <p class="mt-0.5 text-xs text-gray-500">Basic product details</p>
                        </div>
                    ...
                    <div class="grid grid-cols-1 gap-x-8 gap-y-5 p-5 sm:grid-cols-2 sm:p-6">
                        ...
                        <div>
                            ...
                            <p class="mt-1.5 font-medium text-gray-900">{{ $product->name }}</p>
                        </div>

                        <div>
                            <p class="text-xs font-semibold uppercase tracking-wider text-gray-400">SKU</p>
                            <p class="mt-1.5 font-mono font-medium text-gray-900">{{ $product->sku }}</p>
                        </div>

                        <div>
                            <p class="text-xs font-semibold uppercase tracking-wider text-gray-400">Category</p>
                            <p class="mt-1.5 text-gray-800">{{ $product->category->name ?? '—' }}</p>
                        </div>

                        <div>
                            <p class="text-xs font-semibold uppercase tracking-wider text-gray-400">Supplier</p>
                            <p class="mt-1.5 text-gray-800">{{ $product->supplier->name ?? '—' }}</p>
                        </div>

                        <div>
                            <p class="text-xs font-semibold uppercase tracking-wider text-gray-400">Barcode</p>
                        ...
                        <div>
                            <p class="text-xs font-semibold uppercase tracking-wider text-gray-400">Expiry Date</p>
                            <p class="mt-1.5 text-gray-800">
                                {{ $product->expiry_date?->format('M d, Y') ?? 'No expiry date' }}
                            </p>
                        </div>
                ...
                <div class="rounded-2xl border border-gray-200 bg-white shadow-sm">
                    <div class="border-b border-gray-100 px-5 py-4">
                        ...
                        <p class="mt-0.5 text-xs text-gray-500">Current product pricing</p>
                    </div>
                    ...
                    <div class="space-y-4 p-5">
                        ...
                        <div class="rounded-xl border border-indigo-100 bg-indigo-50/60 p-4">
                            <div class="flex items-center justify-between">
                                ...
                                <span class="rounded-full bg-white px-2 py-1 text-xs font-bold text-indigo-700 shadow-sm">
                                    {{ number_format($margin, 1) }}%
                                </span>
                            </div>

                            <p class="mt-2 text-lg font-bold {{ $unitProfit >= 0 ? 'text-indigo-700' : 'text-red-600' }}">
                                {{ rwf($unitProfit) }}
                        ...
                        <div class="border-t border-gray-100 pt-4">
                            <div class="flex items-center justify-between text-sm">
                                <span class="text-gray-500">Stock cost value</span>
                                <span class="font-semibold text-gray-900">{{ rwf($stockValue) }}</span>
                            </div>

                            <div class="mt-2 flex items-center justify-between text-sm">
                                <span class="text-gray-500">Potential sales</span>
                                <span class="font-semibold text-emerald-700">{{ rwf($potentialSales) }}</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section class="rounded-2xl border border-gray-200 bg-white shadow-sm">
                    ...
                    <div class="flex flex-col gap-1 sm:flex-row sm:items-center sm:justify-between">
                        <div>
                            ...
                            <p class="text-xs text-gray-500">
                                Lifetime purchasing and sales activity for this product
                            </p>
                        </div>
                ...
                <div class="grid grid-cols-2 divide-x divide-y divide-gray-100 sm:grid-cols-3 lg:grid-cols-6 lg:divide-y-0">

                    <div class="p-5">
                        <p class="text-xs font-medium text-gray-500">Purchased</p>
                        <p class="mt-2 text-2xl font-bold text-blue-700">
                            {{ number_format($totalPurchased, 2) }}
                        </p>
                        <p class="mt-1 text-xs text-gray-400">Units</p>
                    </div>
                    ...
                    <div class="p-5">
                        ...
                        <p class="mt-2 text-2xl font-bold {{ $stockValueClass }}">
                            {{ number_format($product->stock, 2) }}
                        </p>
                        <p class="mt-1 text-xs text-gray-400">Units</p>
                    </div>
                    ...
                    <div class="p-5">
                        <p class="text-xs font-medium text-gray-500">Purchase Value</p>
                        <p class="mt-2 text-lg font-bold text-gray-900">
                            {{ rwf($totalPurchaseCost) }}
                        </p>
                        <p class="mt-1 text-xs text-gray-400">Total cost</p>
                    </div>

                    <div class="p-5">
                        <p class="text-xs font-medium text-gray-500">Sales Value</p>
                        <p class="mt-2 text-lg font-bold text-gray-900">
                            {{ rwf($totalSales) }}
                        </p>
                        <p class="mt-1 text-xs text-gray-400">Revenue</p>
                    </div>

                    <div class="p-5">
                        <p class="text-xs font-medium text-gray-500">Gross Profit</p>
                        <p class="mt-2 text-lg font-bold {{ $grossProfit >= 0 ? 'text-emerald-700' : 'text-red-600' }}">
                            {{ rwf($grossProfit) }}
                        </p>
                        <p class="mt-1 text-xs {{ $grossProfit >= 0 ? 'text-emerald-600' : 'text-red-500' }}">
            ...
            <section class="overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-sm">
                <div class="flex flex-col gap-3 border-b border-gray-100 px-5 py-4 sm:flex-row sm:items-center sm:justify-between sm:px-6">
                    ...
                    <div class="rounded-lg bg-blue-50 px-3 py-1.5 text-xs font-semibold text-blue-700">
                        {{ number_format($totalPurchased, 2) }} units purchased
                    </div>
                </div>
                        ...
                        <tbody class="divide-y divide-gray-100 bg-white">
                            @forelse($purchaseItems as $item)
                                <tr class="transition hover:bg-gray-50/70">
                                    ...
                                    <td class="whitespace-nowrap px-5 py-4 text-right text-sm font-semibold text-gray-800">
                                        {{ number_format($item->quantity, 2) }}
                                    </td>

                                    <td class="whitespace-nowrap px-5 py-4 text-right text-sm text-gray-600">
                                        {{ rwf($item->unit_cost) }}
                                    </td>
                            ...
                            @empty
                                <tr>
                                    <td colspan="6" class="px-5 py-12 text-center">
                                        ...
                                        <p class="mt-3 text-sm font-semibold text-gray-700">No purchases found</p>
                                        <p class="mt-1 text-xs text-gray-400">Purchase history will appear here.</p>
                                    </td>
                                </tr>
                            @endforelse
                        </tbody>
            ...
            <section class="overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-sm">
                <div class="flex flex-col gap-3 border-b border-gray-100 px-5 py-4 sm:flex-row sm:items-center sm:justify-between sm:px-6">
                    <div>
                        <h3 class="font-semibold text-gray-900">Sales History</h3>
                        <p class="mt-0.5 text-xs text-gray-500">
                            Sales, revenue and realized profit
                        </p>
                    </div>

                    <div class="rounded-lg bg-emerald-50 px-3 py-1.5 text-xs font-semibold text-emerald-700">
                        {{ number_format($totalSold, 2) }} units sold
                    </div>
                </div>
                            ...
                            @forelse($saleItems as $item)
                                ...
                                <tr class="transition hover:bg-gray-50/70">
                                    ...
                                    <td class="whitespace-nowrap px-5 py-4 text-right">
                                        <span class="inline-flex rounded-lg px-2.5 py-1 text-sm font-bold
                                            {{ $itemProfit >= 0
                                    ...
                                    <td class="whitespace-nowrap px-5 py-4">
                                        <div class="flex items-center gap-2">
                                            <div class="flex h-7 w-7 items-center justify-center rounded-full bg-indigo-50 text-xs font-bold text-indigo-600">
                            ...
                            @empty
                                ...
                                <tr>
                                    <td colspan="7" class="px-5 py-12 text-center">
                                        ...
                                        <p class="mt-3 text-sm font-semibold text-gray-700">No sales found</p>
                                        <p class="mt-1 text-xs text-gray-400">Sales history will appear here.</p>
                                    </td>
                                </tr>
            ...
            <section class="grid grid-cols-1 gap-6 md:grid-cols-2">
                ...
                <div class="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <h3 class="font-semibold text-gray-900">Last Purchase</h3>
                            <p class="text-xs text-gray-500">Most recent stock acquisition</p>
                        </div>
                    </div>
                ...
                <div class="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <h3 class="font-semibold text-gray-900">Last Sale</h3>
                            <p class="text-xs text-gray-500">Most recent customer transaction</p>
                        </div>
                    </div>
                    ...
                    @if($lastSale)
                        ...
                        @php
                            $lastSaleProfit = (
                                ($lastSale->unit_price ?? 0)
                                - ($lastSale->cost_price_at_sale ?? 0)
                            ) * ($lastSale->quantity ?? 0);
                        @endphp
                        ...
                        <div class="mt-5 rounded-xl bg-gray-50 p-4">
                            ...
                            <div class="flex items-center justify-between">
                                <span class="text-sm text-gray-500">Quantity</span>
                                <span class="font-bold text-gray-900">
                                    {{ number_format($lastSale->quantity, 2) }}
                                </span>
                            </div>
                            ...
                            <div class="mt-3 flex items-center justify-between border-t border-gray-200 pt-3">
                                ...
                                <span class="font-bold {{ $lastSaleProfit >= 0 ? 'text-emerald-700' : 'text-red-600' }}">
                                    {{ rwf($lastSaleProfit) }}
                                </span>
                            </div>
            ...
            ========================================================== --}}
            @if(auth()->user()->isSystemAdmin() || auth()->user()->isShopAdmin())
                <section class="flex flex-col-reverse gap-3 border-t border-gray-200 pt-6 sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <form action="{{ route('products.destroy', $product) }}"
                        ...
                        <button type="submit"
                                class="inline-flex w-full items-center justify-center gap-2 rounded-xl border border-red-200 bg-white px-4 py-2.5 text-sm font-semibold text-red-600 shadow-sm transition hover:bg-red-50 sm:w-auto">
                            <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8"
                    ...
                    <div class="flex w-full gap-3 sm:w-auto">
                        <a href="{{ route('products.index') }}"
                           class="inline-flex flex-1 items-center justify-center rounded-xl border border-gray-200 bg-white px-4 py-2.5 text-sm font-semibold text-gray-700 shadow-sm transition hover:bg-gray-50 sm:flex-none">
                            Cancel
                        </a>

                        <a href="{{ route('products.edit', $product) }}"
                           class="inline-flex flex-1 items-center justify-center gap-2 rounded-xl bg-indigo-600 px-5 py-2.5 text-sm font-semibold text-white shadow-sm transition hover:bg-indigo-700 sm:flex-none">
                            <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8"
                                      d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h5m4-15l2 2m-2-2l-8 8v3h3l8-8m0 0l2 2"/>
                            </svg>

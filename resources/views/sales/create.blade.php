<x-app-layout>
    ...
    <template id="itemTemplate">
        <div class="item-row bg-gray-50 rounded-lg p-4" data-index="__INDEX__">
            <div class="grid grid-cols-12 gap-4">
                ...
                <div class="col-span-2">
                    <label class="block text-sm font-medium text-gray-700 mb-1">{{ __('Unit Price') }} (RWF) *</label>
    ...
    <script>
        ...
        document.getElementById('saleForm').addEventListener('submit', function(e) {
            ...
            if (hasStockError) {
                e.preventDefault();
                alert('{{ __('Cannot complete sale: One or more items exceed available stock. Please adjust quantities.') }}');
            }
        });

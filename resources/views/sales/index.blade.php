                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead class="bg-gray-50">
                            <tr>
                                ...
                                <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">{{ __('Sold By') }}</th>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr>
                                <td colspan="7" class="px-6 py-12 text-center text-gray-500">
                                    ...
                                    <h3 class="mt-2 text-sm font-medium text-gray-900">{{ __('No sales') }}</h3>
                                    <p class="mt-1 text-sm text-gray-500">{{ __('Get started by recording a new sale.') }}</p>
                                    <div class="mt-6">

                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    ...
                                    @else
                                        <span class="text-sm text-gray-400">{{ __('No supplier') }}</span>
                                    @endif
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                    {{ $purchase->items->count() }} {{ __('items') }}
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span class="text-sm font-semibold text-red-600">{{ rwf($purchase->total_amount) }}</span>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                    {{ $purchase->creator->name ?? __('Unknown') }}
                                </td>
                            ...
                            <tr>
                                <td colspan="7" class="px-6 py-12 text-center text-gray-500">
                                    ...
                                    <h3 class="mt-2 text-sm font-medium text-gray-900">{{ __('No purchases') }}</h3>
                                    <p class="mt-1 text-sm text-gray-500">{{ __('Get started by recording a new purchase.') }}</p>
                                    <div class="mt-6">

        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="bg-white overflow-hidden shadow-sm rounded-lg p-6">
                    ...
                    <dl class="space-y-4">
                        ...
                        <div>
                            ...
                            <dd class="mt-1 text-sm text-gray-900">{{ $supplier->contact_name ?: 'Not specified' }}</dd>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <dd class="mt-1 text-sm text-gray-900">{{ $supplier->address ?: 'Not specified' }}</dd>
                        </div>
                    </dl>
                </div>
            ...
            <div class="bg-white overflow-hidden shadow-sm rounded-lg">
                <div class="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
                    ...
                    <a href="{{ route('purchases.index', ['supplier' => $supplier->id]) }}" class="text-sm text-indigo-600 hover:text-indigo-900">View All</a>
                </div>
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            @empty
                            <tr>
                                <td colspan="5" class="px-6 py-4 text-center text-gray-500">No purchases from this supplier yet</td>
                            </tr>
                            @endforelse
                        </tbody>
                    </table>
            ...
            <div class="mt-6 flex justify-end">
                <form action="{{ route('suppliers.destroy', $supplier) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this supplier? This action cannot be undone.')">
                    @csrf
                    @method('DELETE')

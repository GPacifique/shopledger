...
<head>
    ...
    <!-- SEO Meta Tags -->
    <meta name="description" content="Mahwi - Rwanda's leading multi-Business management system for Incomes,inventory, sales, purchases, and staff management. Sign in to your dashboard.">
    ...
    <style>
      ...
      *{ box-sizing:border-box; }
      ...
      /* Top bar sits in normal flow so it can never overlap the content below it */
      .showcase-topbar{
      ...
      /* Remaining content centers itself in whatever space is left */
      .showcase-body{
        flex:1;
        display:flex;
        flex-direction:column;
      ...
      /* Frame that holds the auto-sliding screenshots */
      .frame{
        position:relative;
        border-radius: 12px;
        background:#0F1826;
      ...
      .remember input{ width:14px; height:14px; accent-color: var(--green); }

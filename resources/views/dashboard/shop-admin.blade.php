...
<div class="py-8">
    <div class="w-full px-0">
                ...
                <div class="relative flex flex-col md:flex-row md:items-center md:justify-between">
                    ...
                    <div class="flex flex-wrap gap-3">
                        ...
                        <a href="{{ route('sales.create') }}"
                           class="inline-flex items-center px-5 py-2.5 bg-white text-indigo-600 rounded-xl font-semibold text-sm hover:bg-indigo-50 transition-all transform hover:scale-105 shadow-lg">
                        ...
                        <a href="{{ route('purchases.create') }}"
                           class="inline-flex items-center px-5 py-2.5 bg-white/20 text-white rounded-xl font-semibold text-sm hover:bg-white/30 transition-all transform hover:scale-105 backdrop-blur">
                        ...
                        <a href="{{ route('other_incomes.create') }}"
                           class="inline-flex items-center px-5 py-2.5 bg-emerald-400/90 text-white rounded-xl font-semibold text-sm hover:bg-emerald-500 transition-all transform hover:scale-105 shadow-lg">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            ...
            {{-- Daily --}}
            <div class="p-5 bg-green-50 shadow rounded-2xl border border-green-100">
                ...
                <div class="mt-3 text-xs text-gray-500 space-y-1">
                    ...
                    <div class="flex justify-between">
                        <span>{{ __('Sales') }}</span>
                        <span>{{ rwf($dailySales) }}</span>
                    </div>

                    <div class="flex justify-between text-emerald-600">
                        <span>{{ __('Other Income') }}</span>
                        <span>{{ rwf($dailyOtherIncome) }}</span>
                    </div>

                    <div class="flex justify-between text-red-500">
                        <span>{{ __('Purchases') }}</span>
                        <span>{{ rwf($dailyPurchases) }}</span>
                    </div>

                    <div class="flex justify-between text-orange-500">
                        <span>{{ __('Expenses') }}</span>
                        <span>{{ rwf($dailyExpenses) }}</span>
                    </div>
            ...
            <div class="p-5 bg-green-50 shadow rounded-2xl border border-green-100">
                ...
                <div class="mt-3 text-xs text-gray-500 space-y-1">
                    ...
                    <div class="flex justify-between">
                        <span>{{ __('Sales') }}</span>
                        <span>{{ rwf($weeklySales) }}</span>
                    </div>

                    <div class="flex justify-between text-emerald-600">
                        <span>{{ __('Other Income') }}</span>
                        <span>{{ rwf($weeklyOtherIncome) }}</span>
                    </div>

                    <div class="flex justify-between text-red-500">
                        <span>{{ __('Purchases') }}</span>
                        <span>{{ rwf($weeklyPurchases) }}</span>
                    </div>

                    <div class="flex justify-between text-orange-500">
                        <span>{{ __('Expenses') }}</span>
                        <span>{{ rwf($weeklyExpenses) }}</span>
                    </div>
            ...
            <div class="p-5 bg-green-50 shadow rounded-2xl border border-green-100">
                ...
                <div class="mt-3 text-xs text-gray-500 space-y-1">
                    ...
                    <div class="flex justify-between">
                        <span>{{ __('Sales') }}</span>
                        <span>{{ rwf($yearlySales) }}</span>
                    </div>

                    <div class="flex justify-between text-emerald-600">
                        <span>{{ __('Other Income') }}</span>
                        <span>{{ rwf($yearlyOtherIncome) }}</span>
                    </div>

                    <div class="flex justify-between text-red-500">
                        <span>{{ __('Purchases') }}</span>
                        <span>{{ rwf($yearlyPurchases) }}</span>
                    </div>

                    <div class="flex justify-between text-orange-500">
                        <span>{{ __('Expenses') }}</span>
                        <span>{{ rwf($yearlyExpenses) }}</span>
                    </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-6 mb-8">
            ...
            <div class="stat-card group bg-white rounded-2xl shadow-sm hover:shadow-xl transition-all duration-300 overflow-hidden border border-gray-100">
                ...
                <div class="p-6">
                    ...
                    <div class="flex items-center justify-between mb-4">
                        ...
                        <div class="h-14 w-14 rounded-2xl bg-gradient-to-br from-green-400 to-emerald-600 flex items-center justify-center shadow-lg">
            ...
            <div class="stat-card group bg-white rounded-2xl shadow-sm hover:shadow-xl transition-all duration-300 overflow-hidden border border-gray-100">
                ...
                <div class="p-6">
                    ...
                    <div class="flex items-center justify-between mb-4">
                        ...
                        <div class="h-14 w-14 rounded-2xl bg-gradient-to-br from-emerald-400 to-teal-600 flex items-center justify-center shadow-lg">
            ...
            <div class="stat-card group bg-white rounded-2xl shadow-sm hover:shadow-xl transition-all duration-300 overflow-hidden border border-gray-100">
                ...
                <div class="p-6">
                    ...
                    <div class="flex items-center justify-between mb-4">
                        ...
                        <div class="h-14 w-14 rounded-2xl bg-gradient-to-br from-red-400 to-rose-600 flex items-center justify-center shadow-lg">
                    ...
                    <h3 class="text-sm font-medium text-gray-500 mb-1">
                        {{ __("Today's Purchases") }}
                    </h3>

                    <p class="text-2xl font-bold text-gray-900">
                        {{ rwf($stats['today_purchases']) }}
                    </p>
                ...
                <div class="h-1 bg-gradient-to-r from-red-400 to-rose-600"></div>
            ...
            <div class="stat-card group bg-white rounded-2xl shadow-sm hover:shadow-xl transition-all duration-300 overflow-hidden border border-gray-100">
                ...
                <div class="p-6">
                    ...
                    <div class="flex items-center justify-between mb-4">
                        ...
                        <div class="h-14 w-14 rounded-2xl bg-gradient-to-br from-teal-400 to-cyan-600 flex items-center justify-center shadow-lg">
                        ...
                        <span class="text-xs font-medium text-teal-600 bg-teal-50 px-2.5 py-1 rounded-full">
                            {{ __('Today') }}
                        </span>
                ...
                <div class="h-1 bg-gradient-to-r from-teal-400 to-cyan-600"></div>
            ...
            <div class="stat-card group bg-white rounded-2xl shadow-sm hover:shadow-xl transition-all duration-300 overflow-hidden border border-gray-100">
                ...
                <div class="p-6">
                    ...
                    <div class="p-6">
                        ...
                        <div class="flex items-center justify-between mb-4">
                            ...
                            <div class="h-14 w-14 rounded-2xl bg-gradient-to-br from-orange-400 to-amber-600 flex items-center justify-center shadow-lg">
                            ...
                            <span class="text-xs font-medium text-orange-600 bg-orange-50 px-2.5 py-1 rounded-full">
                                {{ __('Today') }}
                            </span>
                ...
                <div class="h-1 bg-gradient-to-r from-orange-400 to-amber-600"></div>
            ...
            <div class="stat-card group bg-white rounded-2xl shadow-sm hover:shadow-xl transition-all duration-300 overflow-hidden border border-gray-100">
                ...
                <div class="p-6">
                    ...
                    <div class="flex items-center justify-between mb-4">
                        ...
                        <div class="h-14 w-14 rounded-2xl bg-gradient-to-br from-indigo-400 to-blue-600 flex items-center justify-center shadow-lg">
                ...
                <div class="h-1 bg-gradient-to-r from-indigo-400 to-blue-600"></div>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                ...
                <div class="p-6">
                    ...
                    <div class="space-y-4">
                        ...
                        {{-- Other Income --}}
                        <div class="flex justify-between items-center p-4 bg-gradient-to-r from-emerald-50 to-teal-50 rounded-xl">
                        ...
                        {{-- Expenses --}}
                        <div class="flex justify-between items-center p-4 bg-gradient-to-r from-orange-50 to-amber-50 rounded-xl">
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                ...
                <div class="p-6 space-y-3">
                    ...
                    @forelse(\App\Models\Sale::PAYMENT_METHODS as $method => $label)
                        ...
                        <div class="flex justify-between items-center p-4 bg-gradient-to-r
                            {{ $paymentBgColors[$method] ?? 'from-gray-50 to-gray-100' }}
                            rounded-xl">

                            <div class="flex items-center">

                                <div class="h-10 w-10 rounded-lg bg-gradient-to-br
                                    {{ $paymentColors[$method] ?? 'from-gray-400 to-gray-500' }}
                                    flex items-center justify-center mr-3 shadow">
                            ...
                            <span class="text-lg font-bold text-gray-900">
                                {{ rwf($paymentMethodStats['today'][$method] ?? 0) }}
                            </span>
                ...
                <div class="p-6 space-y-3">
                    ...
                    @forelse(\App\Models\Sale::PAYMENT_METHODS as $method => $label)
                        ...
                        <div class="flex justify-between items-center p-4 bg-gradient-to-r
                            ...
                            <span class="text-lg font-bold text-gray-900">
                                {{ rwf($paymentMethodStats['month'][$method] ?? 0) }}
                            </span>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                ...
                <div class="px-6 py-4 border-b border-gray-100 bg-gradient-to-r from-gray-50 to-white">
                    ...
                    <div class="flex flex-wrap gap-4 mt-2 text-xs">
                        ...
                        <span class="flex items-center">
                            <span class="w-3 h-3 rounded-full bg-emerald-400 mr-1"></span>
                            {{ __('Other Income') }}
                        </span>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                ...
                <div class="p-4 space-y-2">
                    ...
                    <a href="{{ route('sales.create') }}"
                       class="flex items-center p-3 rounded-xl hover:bg-green-50 transition-all group">

                        <div class="h-10 w-10 rounded-lg bg-green-100 text-green-600 flex items-center justify-center">
                            +
                        </div>

                        <span class="ml-3 font-medium text-gray-700 group-hover:text-green-700">
                            {{ __('New Sale') }}
                        </span>
                    ...
                    <a href="{{ route('purchases.create') }}"
                       class="flex items-center p-3 rounded-xl hover:bg-red-50 transition-all group">
                    ...
                    {{-- NEW OTHER INCOME --}}
                    <a href="{{ route('other_incomes.create') }}"
                       class="flex items-center p-3 rounded-xl hover:bg-emerald-50 transition-all group">
                        ...
                        <span class="ml-3 font-medium text-gray-700 group-hover:text-emerald-700">
                            {{ __('Add Other Income') }}
                        </span>
                    ...
                    <a href="{{ route('products.create') }}"
                       class="flex items-center p-3 rounded-xl hover:bg-indigo-50 transition-all group">

                        <div class="h-10 w-10 rounded-lg bg-indigo-100 text-indigo-600 flex items-center justify-center">
                            +
                        </div>

                        <span class="ml-3 font-medium text-gray-700 group-hover:text-indigo-700">
                            {{ __('Add Product') }}
                        </span>
            ...
            <div class="lg:col-span-2 bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                ...
                <div class="px-6 py-4 border-b border-gray-100">
                    ...
                    <div class="flex space-x-2" role="tablist">
                        ...
                        <button type="button"
                                data-tab-target="tab-sales"
                                class="tab-btn px-3 py-1.5 rounded-lg text-sm font-semibold bg-indigo-600 text-white">
                        ...
                        <button type="button"
                                data-tab-target="tab-purchases"
                                class="tab-btn px-3 py-1.5 rounded-lg text-sm font-semibold text-gray-600">
                        ...
                        <button type="button"
                                data-tab-target="tab-other-income"
                                class="tab-btn px-3 py-1.5 rounded-lg text-sm font-semibold text-gray-600">
                ...
                {{-- OTHER INCOME --}}
                <div id="tab-other-income" class="tab-panel overflow-x-auto hidden">
                    ...
                    <table class="min-w-full">
                        ...
                        <tbody class="divide-y divide-gray-100">
                            ...
                            @forelse($recentOtherIncomes as $income)
                                    ...
                                    <td class="px-6 py-4">
                                        ...
                                        <a href="{{ route('other_incomes.show', $income) }}"
                                           class="text-emerald-600 hover:text-emerald-800 font-semibold">
                                            ...
                                            #{{ str_pad($income->id, 5, '0', STR_PAD_LEFT) }}
                            ...
                            @empty
                                ...
                                <tr>
                                    ...
                                    <td colspan="4"
                                        ...
                                        {{ __('No other income recorded yet') }}
                    ...
                    @forelse($recentStockMovements as $movement)
                        ...
                        <div class="flex items-center justify-between px-6 py-3">
                            ...
                            <div class="flex items-center">
                                ...
                                <div class="h-9 w-9 rounded-lg flex items-center justify-center mr-3
                                    {{ $isIn
        ...
        <div class="mt-6 bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
            ...
            <div class="p-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                @empty
                    ...
                    <p class="text-gray-500 text-center py-4 sm:col-span-2 lg:col-span-3">
                        {{ __('No staff added yet') }}
                    </p>
    ...
    document.addEventListener('DOMContentLoaded', function () {
                    ...
                    data: {
                        ...
                        datasets: [
...

                            {
                                ...
                                data:
                                    {!! json_encode($chartData['other_income'] ?? []) !!},
...

                            {
                                ...
                                data:
                                    {!! json_encode($chartData['purchases'] ?? []) !!},
...

                            {
                                ...
                                data:
                                    {!! json_encode($chartData['expenses'] ?? []) !!},
            ...
            new Chart(
                monthlyCtx.getContext('2d'),
                {
                    ...
                    data: {
                        ...
                        labels:
                            {!! json_encode($monthlyChartData['labels'] ?? []) !!},
                        ...
                        datasets: [

                            {
                                ...
                                data:
                                    {!! json_encode($monthlyChartData['sales'] ?? []) !!},
...

                            {
                                ...
                                data:
                                    {!! json_encode($monthlyChartData['other_income'] ?? []) !!},
...

                            {
                                ...
                                data:
                                    {!! json_encode($monthlyChartData['purchases'] ?? []) !!},
...

                            {
                                ...
                                data:
                                    {!! json_encode($monthlyChartData['expenses'] ?? []) !!},
        ...
        */
        ...
        if (salesCategoryCtx) {
            ...
            const labels =
                {!! json_encode(
                    $salesCategoryData->pluck('category')->toArray() ?? []
                ) !!};
            ...
            new Chart(
                salesCategoryCtx.getContext('2d'),
                {
        ...
        */
        ...
        if (expenseCategoryCtx) {
            ...
            const labels =
                {!! json_encode(
                    $expenseCategoryData->pluck('category')->toArray() ?? []
                ) !!};
            ...
            new Chart(
                expenseCategoryCtx.getContext('2d'),
                {
